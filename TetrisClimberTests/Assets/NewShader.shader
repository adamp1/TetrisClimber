...
////// Emissive:
                ...
                float4 node_8800 = _Time;
                float node_3917 = floor((sin(node_8800.g)*10.0));
                float2 node_8767 = ((sceneUVs.rg*1.5)+node_3917);
                float4 _hatch_var = tex2D(_hatch,TRANSFORM_TEX(node_8767, _hatch));
                float node_2162 = 1.0;
                float node_8227_if_leA = step((1.0 - node_5330),node_2162);
                float node_8227_if_leB = step(node_2162,(1.0 - node_5330));
                float node_8327 = saturate(lerp(node_5330,(_hatch_var.r*0.15),lerp((node_8227_if_leA*0.0)+(node_8227_if_leB*node_2162),node_2162,node_8227_if_leA*node_8227_if_leB)));
