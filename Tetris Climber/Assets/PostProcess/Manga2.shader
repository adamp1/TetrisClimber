...
////// Emissive:
                ...
                float node_9686 = dot(node_1672.rgb,float3(0.3,0.59,0.11));
                float node_7014 = (saturate(node_9686)+0.0);
                float node_5372 = 1.0;
