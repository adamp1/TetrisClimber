...
////// Emissive:
                ...
                float node_6286 = (_boom2+_boom);
                float3 emissive = lerp(lerp(_NormalColor.rgb,((_GlowColor.rgb*_emintensity)-(sin((node_98.g*5.0))/10.0)),_emmask_var.r),(_glow.rgb*_glowintensity),node_6286);
