...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:3138,x:33532,y:32800,varname:node_3138,prsc:2|emission-9562-OUT,voffset-467-OUT;n:type:ShaderForge.SFN_Color,id:7241,x:32188,y:32736,ptovrint:False,ptlb:Glow Color,ptin:_GlowColor,varname:node_7241,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.07843138,c2:0.3921569,c3:0.7843137,c4:1;n:type:ShaderForge.SFN_Color,id:3782,x:32486,y:32607,ptovrint:False,ptlb:Normal Color,ptin:_NormalColor,varname:node_3782,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_Color,id:9899,x:31844,y:33147,ptovrint:False,ptlb:Inactive Color,ptin:_InactiveColor,varname:node_9899,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5471698,c2:0.5471698,c3:0.5471698,c4:1;n:type:ShaderForge.SFN_Tex2d,id:6961,x:32048,y:33027,ptovrint:False,ptlb:em mask,ptin:_emmask,varname:node_6961,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:9cabc06a5e2c03d43b9584e1751e79a6,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:5021,x:32486,y:32791,varname:node_5021,prsc:2|A-7241-RGB,B-5591-OUT;n:type:ShaderForge.SFN_ValueProperty,id:5591,x:32165,y:32927,ptovrint:False,ptlb:em intensity,ptin:_emintensity,varname:node_5591,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:10;n:type:ShaderForge.SFN_Lerp,id:9562,x:32859,y:32960,varname:node_9562,prsc:2|A-3782-RGB,B-9546-OUT,T-6961-R;n:type:ShaderForge.SFN_Time,id:98,x:32228,y:33195,varname:node_98,prsc:2;n:type:ShaderForge.SFN_Sin,id:9435,x:32553,y:33193,varname:node_9435,prsc:2|IN-9450-OUT;n:type:ShaderForge.SFN_Subtract,id:9546,x:32592,y:32954,varname:node_9546,prsc:2|A-5021-OUT,B-1673-OUT;n:type:ShaderForge.SFN_Multiply,id:9450,x:32412,y:33309,varname:node_9450,prsc:2|A-98-T,B-6266-OUT;n:type:ShaderForge.SFN_Vector1,id:6266,x:32141,y:33402,varname:node_6266,prsc:2,v1:5;n:type:ShaderForge.SFN_Divide,id:1673,x:32748,y:33239,varname:node_1673,prsc:2|A-9435-OUT,B-3356-OUT;n:type:ShaderForge.SFN_Vector1,id:3356,x:32586,y:33387,varname:node_3356,prsc:2,v1:10;n:type:ShaderForge.SFN_Lerp,id:467,x:33286,y:33265,varname:node_467,prsc:2|A-9433-OUT,B-9346-OUT,T-2525-OUT;n:type:ShaderForge.SFN_Slider,id:2525,x:33207,y:33666,ptovrint:False,ptlb:boom,ptin:_boom,varname:node_2525,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_NormalVector,id:4753,x:32696,y:33623,prsc:2,pt:False;n:type:ShaderForge.SFN_Multiply,id:9346,x:32870,y:33674,varname:node_9346,prsc:2|A-4753-OUT,B-7179-OUT;n:type:ShaderForge.SFN_ValueProperty,id:7179,x:32674,y:33825,ptovrint:False,ptlb:offset,ptin:_offset,varname:node_7179,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,v1:1;n:type:ShaderForge.SFN_Vector3,id:9433,x:32952,y:33229,varname:node_9433,prsc:2,v1:0,v2:0,v3:0;n:type:ShaderForge.SFN_Lerp,id:9179,x:33307,y:33026,varname:node_9179,prsc:2|T-2525-OUT;proporder:7241-3782-6961-5591-2525-7179;pass:END;sub:END;*/
...
////// Emissive:
                ...
                float3 emissive = lerp(_NormalColor.rgb,((_GlowColor.rgb*_emintensity)-(sin((node_98.g*5.0))/10.0)),_emmask_var.r);
