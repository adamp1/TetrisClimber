    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_5449 = (mul(unity_ObjectToWorld, v.vertex).rgb-objPos.rgb).rgb;
                float node_6286 = (_boom2+_boom);
                v.vertex.xyz += lerp(float3(0,0,0),(((float3(float2(node_5449.r,0.0),node_5449.b)*0.0)*_offset)+0.0),node_6286);
