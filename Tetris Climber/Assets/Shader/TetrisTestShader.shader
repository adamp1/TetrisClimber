    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += lerp(float3(0,0,0),((v.normal+(sin(v.normal)*0.01))*_offset),node_6286);
...
////// Emissive:
                ...
                float node_6286 = (_boom2+_boom);
                float3 emissive = lerp(lerp(_NormalColor.rgb,((_GlowColor.rgb*_emintensity)-(sin((node_98.g*5.0))/10.0)),_emmask_var.r),((_glow.rgb*(abs(sin(i.posWorld.rgb))+0.1))*_glowintensity),node_6286);
