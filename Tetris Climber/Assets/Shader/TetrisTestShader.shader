    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += lerp(float3(0,0,0),((((v.normal*(sin(((cos(o.uv0.r)*sin(o.uv0.g))*1000.0))*2.0))*1.0)*_offset)+0.0),node_6286);
...
////// Emissive:
                ...
                float node_6286 = (_boom2+_boom);
                float3 emissive = lerp(lerp(_NormalColor.rgb,((_GlowColor.rgb*_emintensity)-(sin((node_98.g*5.0))/10.0)),_emmask_var.r),(_glowintensity*_GlowColor.rgb),node_6286);
