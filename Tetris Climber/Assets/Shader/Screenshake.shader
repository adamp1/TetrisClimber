...
////// Emissive:
                ...
                float node_3129 = 0.004;
                float node_6916 = (frac((sin(node_4454)*100.0))*node_3129);
                float2 node_3385 = ((i.uv0*1.01)+float2((frac((sin(node_4454)*1000.0))*node_3129),node_6916));
