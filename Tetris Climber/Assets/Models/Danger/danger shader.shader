    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 _noise2_var = tex2Dlod(_noise2,float4(TRANSFORM_TEX(node_2227, _noise2),0.0,0));
