...
////// Lighting:
////// Emissive:
                float2 node_1196 = (_tile*i.uv0);
                float4 node_3683 = _Time;
                float2 node_3975 = (node_1196+((node_3683.g*_movespeed)*float2(_dir.r,_dir.g)));
