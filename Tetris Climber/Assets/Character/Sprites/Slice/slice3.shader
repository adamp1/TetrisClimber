    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip(((_node_833_var.a*_gradient_var.a*(_node_833_var.r*_node_833_var.a))+_alpha) - 0.5);
////// Lighting:
////// Emissive:
