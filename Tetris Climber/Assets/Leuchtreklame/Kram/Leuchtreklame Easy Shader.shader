...
////// Emissive:
                ...
                float node_9929 = lerp(0.0,_emission,frac((sin(dot(float2(((objPos.r+objPos.g)+objPos.b),(node_6317.r*_randomspeed)),float2(12.98,78.23)))*43758.55)));
                float3 emissive = (_tex_var.rgb*node_9929);
