    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip((1.0 - step(_mask_var.r,_masksize)) - 0.5);
////// Lighting:
////// Emissive:
